...
import {oauthAuthorizationRedirect} from '@/server/gmail/oauth-browser-binding';
...
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    ...
    return oauthAuthorizationRedirect(authorizationUrl, state, requestUrl.protocol === 'https:');
  } catch (error) {
