CREATE TABLE "ai_interpretation_runs" (
	...
	"provider_model_identifier" text,
	"basis_evidence_revision" bigint NOT NULL,
	"status" text DEFAULT 'CAPTURED' NOT NULL,
	"context_manifest" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"created_at" timestamp (3) with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "ai_interpretation_runs_id_user_uq" UNIQUE("id","user_id"),
	CONSTRAINT "ai_interpretation_runs_schema_version_check" CHECK ("ai_interpretation_runs"."schema_version" >= 1),
	CONSTRAINT "ai_interpretation_runs_basis_revision_check" CHECK ("ai_interpretation_runs"."basis_evidence_revision" >= 0),
	CONSTRAINT "ai_interpretation_runs_manifest_object_check" CHECK (jsonb_typeof("ai_interpretation_runs"."context_manifest") = 'object'),
	CONSTRAINT "ai_interpretation_runs_model_config_version_check" CHECK (char_length(btrim("ai_interpretation_runs"."model_config_version")) BETWEEN 1 AND 128)
);
...
--> statement-breakpoint
ALTER TABLE "ai_interpretation_runs" ADD CONSTRAINT "ai_interpretation_runs_user_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ai_interpretation_runs" ADD CONSTRAINT "ai_interpretation_runs_conversation_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ai_interpretation_runs" ADD CONSTRAINT "ai_interpretation_runs_message_fk" FOREIGN KEY ("message_id") REFERENCES "public"."messages"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "responsibilities" ADD CONSTRAINT "responsibilities_account_owner_fk" FOREIGN KEY ("connected_account_id","user_id") REFERENCES "public"."connected_accounts"("id","user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "responsibilities" ADD CONSTRAINT "responsibilities_conversation_account_fk" FOREIGN KEY ("conversation_id","connected_account_id") REFERENCES "public"."conversations"("id","connected_account_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "responsibility_admission_reviews" ADD CONSTRAINT "responsibility_admission_reviews_account_owner_fk" FOREIGN KEY ("connected_account_id","user_id") REFERENCES "public"."connected_accounts"("id","user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "responsibility_admission_reviews" ADD CONSTRAINT "responsibility_admission_reviews_conversation_account_fk" FOREIGN KEY ("conversation_id","connected_account_id") REFERENCES "public"."conversations"("id","connected_account_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "responsibility_admission_reviews" ADD CONSTRAINT "responsibility_admission_reviews_interpretation_run_user_fk" FOREIGN KEY ("interpretation_run_id","user_id") REFERENCES "public"."ai_interpretation_runs"("id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "responsibility_domain_events" ADD CONSTRAINT "responsibility_domain_events_interpretation_run_user_fk" FOREIGN KEY ("interpretation_run_id","user_id") REFERENCES "public"."ai_interpretation_runs"("id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "responsibility_expected_events" ADD CONSTRAINT "responsibility_expected_events_participant_user_fk" FOREIGN KEY ("actor_participant_id","user_id") REFERENCES "public"."participant_identities"("id","user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "responsibility_obligation_legs" ADD CONSTRAINT "responsibility_obligation_legs_participant_user_fk" FOREIGN KEY ("bearer_participant_id","user_id") REFERENCES "public"."participant_identities"("id","user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "responsibility_provenance_refs" ADD CONSTRAINT "responsibility_provenance_refs_message_account_fk" FOREIGN KEY ("message_id","connected_account_id") REFERENCES "public"."messages"("id","connected_account_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "responsibility_provenance_refs" ADD CONSTRAINT "responsibility_provenance_refs_interpretation_run_user_fk" FOREIGN KEY ("interpretation_run_id","user_id") REFERENCES "public"."ai_interpretation_runs"("id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ai_interpretation_runs_user_idx" ON "ai_interpretation_runs" USING btree ("user_id","created_at");--> statement-breakpoint
...
CREATE INDEX "responsibility_domain_events_source_idx" ON "responsibility_domain_events" USING btree ("source_event_key","occurred_at" DESC NULLS LAST,"id");--> statement-breakpoint
